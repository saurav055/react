        ...
        <ScreenContainer>
            <Box sx={{ flex: 1, diplay: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%', height: '100%', marginX: 'auto' }}>
                <Card sx={{ backgroundColor: 'primary.shade1', height: '100%', marginX: { laptop: '30%', mobile: '10%' } }}>
                    ...
                    <Typography sx={{ textAlign: 'center', fontSize: '1.5em' }} >Reset Password</Typography>
                    ...
                    <Box height="10vh" display="flex" alignItems="center" sx={{ marginX: 'auto', alignSelf: 'center', alignItems: 'center', marginY: '1em' }}>
                        <Button onClick={() => { alert("Reset password link has been sent to your email."); navigate("/", { replace: true }) }} variant="contained" color="secondary" size={"large"} sx={{ width: { laptop: '30%', mobile: '60%' }, marginX: 'auto', fontSize: "1em" }} >Submit</Button>
                    </Box>
